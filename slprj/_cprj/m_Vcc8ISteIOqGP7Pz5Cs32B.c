...
#include "m_Vcc8ISteIOqGP7Pz5Cs32B.h"
...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2018b\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidDataDisplay.p"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
static void mw__internal__system__init__fcn(void);
static void mw__internal__call__setup(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S, int_T tid)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S, int_T tid)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static void setSimState_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
  InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *moduleInstance =
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B *)calloc(1, sizeof
    (InstanceStruct_Vcc8ISteIOqGP7Pz5Cs32B));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Vcc8ISteIOqGP7Pz5Cs32B);
  ssSetmdlInitializeConditions(S, mdlInitialize_Vcc8ISteIOqGP7Pz5Cs32B);
  ssSetmdlUpdate(S, mdlUpdate_Vcc8ISteIOqGP7Pz5Cs32B);
  ssSetmdlTerminate(S, mdlTerminate_Vcc8ISteIOqGP7Pz5Cs32B);
  ssSetmdlEnable(S, mdlEnable_Vcc8ISteIOqGP7Pz5Cs32B);
  ssSetmdlDisable(S, mdlDisable_Vcc8ISteIOqGP7Pz5Cs32B);
...
static void mdlProcessParameters_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S)
{
}

void method_dispatcher_Vcc8ISteIOqGP7Pz5Cs32B(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Vcc8ISteIOqGP7Pz5Cs32B(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Vcc8ISteIOqGP7Pz5Cs32B(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_Vcc8ISteIOqGP7Pz5Cs32B(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_Vcc8ISteIOqGP7Pz5Cs32B(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Vcc8ISteIOqGP7Pz5Cs32B.\n"
...
mxArray *cgxe_Vcc8ISteIOqGP7Pz5Cs32B_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Vcc8ISteIOqGP7Pz5Cs32B_fallback_info(void)
{
