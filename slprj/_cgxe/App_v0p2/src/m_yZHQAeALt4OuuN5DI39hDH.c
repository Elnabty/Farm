...
#include "m_yZHQAeALt4OuuN5DI39hDH.h"
...
static void cgxe_mdl_start(InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
static void mw__internal__system__init__fcn(void);
static void mw__internal__call__setup(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance, const emlrtStack *sp);
static boolean_T mw__internal__call__step(InstanceStruct_yZHQAeALt4OuuN5DI39hDH *
  moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
...
static boolean_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_yZHQAeALt4OuuN5DI39hDH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_yZHQAeALt4OuuN5DI39hDH(SimStruct *S, int_T tid)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_yZHQAeALt4OuuN5DI39hDH(SimStruct *S, int_T tid)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_yZHQAeALt4OuuN5DI39hDH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
  InstanceStruct_yZHQAeALt4OuuN5DI39hDH *moduleInstance =
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH *)calloc(1, sizeof
    (InstanceStruct_yZHQAeALt4OuuN5DI39hDH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_yZHQAeALt4OuuN5DI39hDH);
  ssSetmdlInitializeConditions(S, mdlInitialize_yZHQAeALt4OuuN5DI39hDH);
  ssSetmdlUpdate(S, mdlUpdate_yZHQAeALt4OuuN5DI39hDH);
  ssSetmdlTerminate(S, mdlTerminate_yZHQAeALt4OuuN5DI39hDH);
  ssSetmdlEnable(S, mdlEnable_yZHQAeALt4OuuN5DI39hDH);
  ssSetmdlDisable(S, mdlDisable_yZHQAeALt4OuuN5DI39hDH);
...
static void mdlProcessParameters_yZHQAeALt4OuuN5DI39hDH(SimStruct *S)
{
}

void method_dispatcher_yZHQAeALt4OuuN5DI39hDH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_yZHQAeALt4OuuN5DI39hDH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_yZHQAeALt4OuuN5DI39hDH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_yZHQAeALt4OuuN5DI39hDH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_yZHQAeALt4OuuN5DI39hDH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: yZHQAeALt4OuuN5DI39hDH.\n"
...
mxArray *cgxe_yZHQAeALt4OuuN5DI39hDH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_yZHQAeALt4OuuN5DI39hDH_fallback_info(void)
{
