...
public class App_v0p2 extends AppCompatActivity implements OnFragmentInteractionListener{
    ...
    private App_v0p2 thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","App_v0p2"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("App_v0p2.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    private native int naMain(String[] argv, App_v0p2 pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("App_v0p2");
    }
