...
#include "m_WqYNctr5az53WvPBtSKqtE.h"
...
static void cgxe_mdl_start(InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
static void mw__internal__system__init__fcn(void);
static void mw__internal__call__setup(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_WqYNctr5az53WvPBtSKqtE
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_WqYNctr5az53WvPBtSKqtE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_WqYNctr5az53WvPBtSKqtE(SimStruct *S, int_T tid)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_WqYNctr5az53WvPBtSKqtE(SimStruct *S, int_T tid)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_WqYNctr5az53WvPBtSKqtE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
  InstanceStruct_WqYNctr5az53WvPBtSKqtE *moduleInstance =
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE *)calloc(1, sizeof
    (InstanceStruct_WqYNctr5az53WvPBtSKqtE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_WqYNctr5az53WvPBtSKqtE);
  ssSetmdlInitializeConditions(S, mdlInitialize_WqYNctr5az53WvPBtSKqtE);
  ssSetmdlUpdate(S, mdlUpdate_WqYNctr5az53WvPBtSKqtE);
  ssSetmdlTerminate(S, mdlTerminate_WqYNctr5az53WvPBtSKqtE);
  ssSetmdlEnable(S, mdlEnable_WqYNctr5az53WvPBtSKqtE);
  ssSetmdlDisable(S, mdlDisable_WqYNctr5az53WvPBtSKqtE);
...
static void mdlProcessParameters_WqYNctr5az53WvPBtSKqtE(SimStruct *S)
{
}

void method_dispatcher_WqYNctr5az53WvPBtSKqtE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_WqYNctr5az53WvPBtSKqtE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_WqYNctr5az53WvPBtSKqtE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_WqYNctr5az53WvPBtSKqtE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_WqYNctr5az53WvPBtSKqtE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: WqYNctr5az53WvPBtSKqtE.\n"
...
mxArray *cgxe_WqYNctr5az53WvPBtSKqtE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_WqYNctr5az53WvPBtSKqtE_fallback_info(void)
{
