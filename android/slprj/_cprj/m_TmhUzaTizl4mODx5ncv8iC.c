...
#include "m_TmhUzaTizl4mODx5ncv8iC.h"
...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  "androidThingSpeakWrite",            /* fcnName */
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2018b\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidThingSpeakWrit"
  "e.p"                                /* pathName */
};

static emlrtRSInfo b_emlrtRSI = { 1,   /* lineNo */
  "androidBlockWithId",                /* fcnName */
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2018b\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidBlockWithId.p"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
static void mw__internal__system__init__fcn(void);
static void mw__internal__call__setup(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance);
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *b_sysobj,
  const char_T *identifier, codertarget_internal_androidThingSpeakWrite *y);
static void b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, codertarget_internal_androidThingSpeakWrite *y);
static int32_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, cell_wrap y[8]);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_TmhUzaTizl4mODx5ncv8iC
  *moduleInstance);
  ...
  *moduleInstance, const emlrtStack *sp)
{
  emlrtStack st;
  emlrtStack b_st;
  codertarget_internal_androidThingSpeakWrite *obj;
  emlrtStack c_st;
  char_T u[51];
  emlrtStack d_st;
  int32_T i0;
  emlrtStack e_st;
  cell_wrap varSizes[8];
  const mxArray *y;
  ...
  for (i0 = 0; i0 < 8; i0++) {
    obj->inputVarSize[i0] = varSizes[i0];
  }
}
  ...
  *moduleInstance, const emlrtStack *sp)
{
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[1].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[1].f1[k] = 1U;
      }
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[2].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[2].f1[k] = 1U;
      }
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[3].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[3].f1[k] = 1U;
      }
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[4].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[4].f1[k] = 1U;
      }
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[5].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[5].f1[k] = 1U;
      }
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[6].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[6].f1[k] = 1U;
      }
  ...
  exitg1 = false;
  while ((!exitg1) && (k < 8)) {
    if (obj->inputVarSize[7].f1[k] != 1U) {
      for (k = 0; k < 8; k++) {
        obj->inputVarSize[7].f1[k] = 1U;
      }
  ...
  (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance)
{
  ...
  cell_wrap hoistedGlobal_inputVarSize[8];
  int32_T i2;
  const mxArray *b_y;
  ...
  for (i2 = 0; i2 < 8; i2++) {
    hoistedGlobal_inputVarSize[i2] = moduleInstance->sysobj.inputVarSize[i2];
  }
  ...
  *(int32_T *)emlrtMxGetData(m4) = hoistedGlobal_isInitialized;
  ...
  for (i2 = 0; i2 < 8; i2++) {
    u[i2] = hoistedGlobal_inputVarSize[i2];
  }
  ...
  emlrtAssign(&c_y, emlrtCreateStructArray(2, iv14, 1, sv1));
  for (i2 = 0; i2 < 8; i2++) {
    r0 = &u[i2];
    ...
    hoistedGlobal_isInitialized = 0;
    for (i = 0; i < 8; i++) {
      pData[hoistedGlobal_isInitialized] = b_u[i];
      hoistedGlobal_isInitialized++;
    }

    emlrtAssign(&d_y, m4);
    emlrtSetFieldR2017b(c_y, i2, "f1", d_y, 0);
  }
  ...
  emlrtMsgIdentifier *parentId, cell_wrap y[8])
{
  ...
  for (i3 = 0; i3 < 8; i3++) {
    ...
    e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i3, 0, "f1")),
                       &thisId, y[i3].f1);
  }
  ...
  *moduleInstance)
{
  ...
  moduleInstance->u1 = (uint8_T *)cgxertGetInputPortSignal(moduleInstance->S, 1);
  moduleInstance->u2 = (uint8_T *)cgxertGetInputPortSignal(moduleInstance->S, 2);
  moduleInstance->u3 = (uint8_T *)cgxertGetInputPortSignal(moduleInstance->S, 3);
  moduleInstance->u4 = (int8_T *)cgxertGetInputPortSignal(moduleInstance->S, 4);
  moduleInstance->u5 = (int8_T *)cgxertGetInputPortSignal(moduleInstance->S, 5);
  moduleInstance->u6 = (int8_T *)cgxertGetInputPortSignal(moduleInstance->S, 6);
  moduleInstance->u7 = (int8_T *)cgxertGetInputPortSignal(moduleInstance->S, 7);
}

/* CGXE Glue Code */
static void mdlOutputs_TmhUzaTizl4mODx5ncv8iC(SimStruct *S, int_T tid)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_TmhUzaTizl4mODx5ncv8iC(SimStruct *S, int_T tid)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_TmhUzaTizl4mODx5ncv8iC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
  InstanceStruct_TmhUzaTizl4mODx5ncv8iC *moduleInstance =
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC *)calloc(1, sizeof
    (InstanceStruct_TmhUzaTizl4mODx5ncv8iC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_TmhUzaTizl4mODx5ncv8iC);
  ssSetmdlInitializeConditions(S, mdlInitialize_TmhUzaTizl4mODx5ncv8iC);
  ssSetmdlUpdate(S, mdlUpdate_TmhUzaTizl4mODx5ncv8iC);
  ssSetmdlTerminate(S, mdlTerminate_TmhUzaTizl4mODx5ncv8iC);
  ssSetmdlEnable(S, mdlEnable_TmhUzaTizl4mODx5ncv8iC);
  ssSetmdlDisable(S, mdlDisable_TmhUzaTizl4mODx5ncv8iC);
...
static void mdlProcessParameters_TmhUzaTizl4mODx5ncv8iC(SimStruct *S)
{
}

void method_dispatcher_TmhUzaTizl4mODx5ncv8iC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_TmhUzaTizl4mODx5ncv8iC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_TmhUzaTizl4mODx5ncv8iC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_TmhUzaTizl4mODx5ncv8iC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_TmhUzaTizl4mODx5ncv8iC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: TmhUzaTizl4mODx5ncv8iC.\n"
...
mxArray *cgxe_TmhUzaTizl4mODx5ncv8iC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
  ...
  elem_9 = mxCreateString("codertarget.internal.androidThingSpeakWrite");
...
mxArray *cgxe_TmhUzaTizl4mODx5ncv8iC_fallback_info(void)
{
  ...
  mxArray* incompatibleSymbol = mxCreateString(
    "codertarget.internal.androidThingSpeakWrite");
