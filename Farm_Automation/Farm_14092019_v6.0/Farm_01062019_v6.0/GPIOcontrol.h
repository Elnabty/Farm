...
#define PORTC_COMFIG PORTC=0;

#define	 A4899 7u
#define	DDRL_CINFIG DDRL|=(1<<A4899);
#define PORTL_CINFIG PORTL|=(1<<A4899);


/*PORTL7 En(Low) Dis(High) Med_Module*/

#define  A4899_EN PORTL&=~(1<<A4899);
#define  A4899_DIS PORTL|=(1<<A4899); 

/*(MEDICINE_PACKET 4PINS LSb)*/
#define MED_1 0u   //First medicine
#define MED_1_ON  PORTC&=~(1<<MED_1);
#define MED_1_OFF PORTC|=(1<<MED_1);
#define MED_1_TOGGLE PORTC^=(1<<MED_1);


#define MED_2 1u   //Second medicine
#define MED_2_ON  PORTC&=~(1<<MED_2);
#define MED_2_OFF PORTC|=(1<<MED_2);
#define MED_2_TOGGLE PORTC^=(1<<MED_2);

#define MED_1_DIR 2u   //MED 1 DIRECRTION 
#define MED_1_CW  PORTC&=~(1<<MED_1_DIR);
#define MED_1_ACW PORTC|=(1<<MED_1_DIR);


#define MED_2_DIR 3u   //MED 2 DIRECRTION
#define MED_2_CW  PORTC&=~(1<<MED_2_DIR);
#define MED_2_ACW PORTC|=(1<<MED_2_DIR);
...
#define SOL_1_ON  PORTL&=~(1<<SOL_1);
#define SOL_1_OFF PORTL|=(1<<SOL_1);

/*Test*/
#define SOL_2 0u   //Second solenoid 
#define SOL_2_ON  PORTB&=~(1<<SOL_2);
#define SOL_2_OFF PORTB|=(1<<SOL_2);
